...
var getGroup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.group.findUnique({
                        where: { id: Number(id) },
            ...
            case 2:
                group = _a.sent();
                if (!group)
                    return [2 /*return*/, res.status(404).send({ title: 'Grupo não encontrado', message: 'Grupo não encontrado' })];
                mixpanel_1.default.track('Get Group', {
                    // @ts-ignore
            ...
            case 3:
                error_1 = _a.sent();
                console.error("[ERROR] [Get Group] Unexpected Error: ".concat(error_1.message));
                res.status(500).send({

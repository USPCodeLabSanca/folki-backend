...
var updateMe = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, body, updatedUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.user.update({ where: { id: user.id }, data: body })
                    // @ts-ignore
                ];
            case 2:
                updatedUser = _a.sent();
                ...
                mixpanel_1.default.track('Update User', {
                    // @ts-ignore
            ...
            case 3:
                error_1 = _a.sent();
                console.error("[ERROR] [User Update Me] Unexpected User Update: ".concat(error_1.message));
                res.status(500).send({
